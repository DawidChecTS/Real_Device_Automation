...
#Wait until element with given text is displayed
Hybrid_button = wait.until(lambda x: x.find_element(AppiumBy.ANDROID_UIAUTOMATOR,
                                                   'new UiScrollable(new UiSelector()).scrollIntoView(text("HYBRID"))'))
